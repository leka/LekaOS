...
namespace pin {
	...
	inline constexpr auto belt_left_front_input	 = uint16_t {leka::mcp23017::pin::PB3};
	inline constexpr auto belt_left_back_input	 = uint16_t {leka::mcp23017::pin::PB2};
	...
	inline constexpr auto belt_left_front_power_mode  = uint16_t {leka::mcp23017::pin::PA3};
	inline constexpr auto belt_left_back_power_mode	  = uint16_t {leka::mcp23017::pin::PA2};
