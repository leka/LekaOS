...
#include "RainbowCallback.h"

namespace leka::led::animation {

static constexpr auto kNumberOfLedsBelt = uint8_t {20};
void RainbowCallback::registerCallback(const mbed::Callback<void()> &callback)
{
	_callback = callback;
}
void RainbowCallback::setLeds(interface::LED &ears, interface::LED &belt)
{
	_ears = &ears;
	_belt = &belt;
}

auto RainbowCallback::isRunning() -> bool
{
	return _running;
}

void RainbowCallback::start()
{
...
void RainbowCallback::stagesRainbow()
{
...
auto RainbowCallback::getRainbowColor(uint8_t index) const -> RGB
{
...
void RainbowCallback::turnLedBlack()
{
