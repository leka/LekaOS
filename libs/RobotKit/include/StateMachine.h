	...
	auto operator()() const
	{
		...
		return make_transition_table(
			...
			* sm::state::setup    + event<sm::event::setup_complete> [sm::guard::is_not_charging {}] = sm::state::idle
			...
			, state<rfid::magic_card::StateMachineActivity> + event<sm::event::command_received> [sm::guard::is_not_charging {} && sm::guard::is_connected {}] = sm::state::working
			, state<rfid::magic_card::StateMachineActivity> + event<sm::event::ble_connection>   [sm::guard::is_not_charging {}]                               = sm::state::working
			, state<rfid::magic_card::StateMachineActivity> + event<sm::event::charge_did_start> [sm::guard::is_charging {}]                                   = sm::state::charging
			, state<rfid::magic_card::StateMachineActivity> + event<sm::event::command_received> [sm::guard::is_charging {} && sm::guard::is_connected {}]     = sm::state::charging
			, state<rfid::magic_card::StateMachineActivity> + event<sm::event::ble_connection>   [sm::guard::is_charging {}]                                   = sm::state::charging
			, state<rfid::magic_card::StateMachineActivity> + event<sm::event::emergency_stop>                                                                 = sm::state::emergency_stopped
