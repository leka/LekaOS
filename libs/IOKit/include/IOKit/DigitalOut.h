...
class DigitalOut : public mbed::interface::DigitalOut, private internal::IO<pin_underlying_type_t>
{
  public:
	...
	void write(int value) override { internal::IO<pin_underlying_type_t>::writeOutput(value); }
	auto read() -> int override { return internal::IO<pin_underlying_type_t>::readOutput(); }
