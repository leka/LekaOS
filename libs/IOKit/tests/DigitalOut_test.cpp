...
{
	EXPECT_CALL(mockIOExpander, setPinAsOutput(pin_number)).Times(1);
	EXPECT_CALL(mockIOExpander, writeOutputPin(pin_number, 0x01)).Times(1);
...
{
	EXPECT_CALL(mockIOExpander, setPinAsOutput(pin_number)).Times(1);
	EXPECT_CALL(mockIOExpander, writeOutputPin(pin_number, 0x00)).Times(1);
...
{
	EXPECT_CALL(mockIOExpander, setPinAsOutput(pin_number)).Times(1);
	EXPECT_CALL(mockIOExpander, readOutputPin(pin_number)).Times(1);
