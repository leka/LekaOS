...
BASE_ARM_GNU_TOOLCHAIN_URL=$(cat config/arm_gnu_toolchain_url)
BASE_ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME="BASE_ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME"
BASE_ARM_GNU_TOOLCHAIN_EXTRACT_DIRECTORY="base_arm_toolchain"

echo "BASE_ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME=$BASE_ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME" >> $GITHUB_ENV
echo "BASE_ARM_GNU_TOOLCHAIN_EXTRACT_DIRECTORY=$BASE_ARM_GNU_TOOLCHAIN_EXTRACT_DIRECTORY" >> $GITHUB_ENV
echo "BASE_ARM_GNU_TOOLCHAIN_URL=$BASE_ARM_GNU_TOOLCHAIN_URL" >> $GITHUB_ENV
...
HEAD_ARM_GNU_TOOLCHAIN_URL=$(cat config/arm_gnu_toolchain_url)
HEAD_ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME="HEAD_ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME"
HEAD_ARM_GNU_TOOLCHAIN_EXTRACT_DIRECTORY="head_arm_toolchain"

echo "HEAD_ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME=$HEAD_ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME" >> $GITHUB_ENV
echo "HEAD_ARM_GNU_TOOLCHAIN_EXTRACT_DIRECTORY=$HEAD_ARM_GNU_TOOLCHAIN_EXTRACT_DIRECTORY" >> $GITHUB_ENV
echo "HEAD_ARM_GNU_TOOLCHAIN_URL=$HEAD_ARM_GNU_TOOLCHAIN_URL" >> $GITHUB_ENV
...
ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME="arm-gnu-toolchain.tar.bz2"
ARM_GNU_TOOLCHAIN_EXTRACT_DIRECTORY="arm-gnu-toolchain"
ARM_GNU_TOOLCHAIN_URL=$(cat config/arm_gnu_toolchain_url)

echo "ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME=$ARM_GNU_TOOLCHAIN_ARCHIVE_FILENAME" >> $GITHUB_ENV
echo "ARM_GNU_TOOLCHAIN_EXTRACT_DIRECTORY=$ARM_GNU_TOOLCHAIN_EXTRACT_DIRECTORY" >> $GITHUB_ENV
echo "ARM_GNU_TOOLCHAIN_URL=$ARM_GNU_TOOLCHAIN_URL" >> $GITHUB_ENV
