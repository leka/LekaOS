...
BASE_SEMVER_VERSION=$(cat config/semver_version)
...
echo "BASE_SEMVER_VERSION=$BASE_SEMVER_VERSION" >> $GITHUB_ENV
...
HEAD_SEMVER_VERSION=$(cat config/semver_version)
...
echo "HEAD_SEMVER_VERSION=$HEAD_SEMVER_VERSION" >> $GITHUB_ENV
