...
namespace rfid::cr95hf {
	...
	namespace settings {
		...
		namespace idle_tag_detection {
			...
			inline constexpr auto wu_source				  = uint8_t {0x0A}; // remove IRQ_IN
			...
			inline constexpr auto digital_to_analog_data  = std::to_array<uint8_t>({0x70, 0x80}); // lower and higer value for tag detection
