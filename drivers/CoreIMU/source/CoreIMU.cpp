...
void CoreIMU::enableOnWakeUpInterrupt()
{
	...
	// ? Set Wakeup config
	lsm6dsox_wkup_threshold_set(&_register_io_function, 16);   // LSB multiplier / Max: 31
	...
	lsm6dsox_act_mode_set(&_register_io_function, LSM6DSOX_XL_AND_GY_NOT_AFFECTED);	  // 4 Modes
