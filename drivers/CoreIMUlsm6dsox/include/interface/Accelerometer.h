...
class Accelerometer
{
  public:
	...
	virtual auto getDataX_mg() -> float = 0;
	virtual auto getDataY_mg() -> float = 0;
	virtual auto getDataZ_mg() -> float = 0;

	virtual auto getDataX_g() -> float = 0;
	virtual auto getDataY_g() -> float = 0;
	virtual auto getDataZ_g() -> float = 0;
