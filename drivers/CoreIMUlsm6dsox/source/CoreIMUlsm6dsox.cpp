...
auto CoreIMU_LSM6DSOX::getDataX_mg() -> float_t {
    lsm6dsox_data_t data;
    lsm6dsox_data_get(&getRegisterIOFunction(), nullptr, &getConfig(), &data);
    return data.ui.xl.mg[0];
}

auto CoreIMU_LSM6DSOX::getDataY_mg() -> float_t{
    lsm6dsox_data_t data;
    lsm6dsox_data_get(&getRegisterIOFunction(), nullptr, &getConfig(), &data);
    return data.ui.xl.mg[1];
}            

auto CoreIMU_LSM6DSOX::getDataZ_mg() -> float_t {
    lsm6dsox_data_t data;
    lsm6dsox_data_get(&getRegisterIOFunction(), nullptr, &getConfig(), &data);
    return data.ui.xl.mg[2];
}


auto CoreIMU_LSM6DSOX::getDataX_g() -> float_t {
    return getDataX_mg()/1000;
}

auto CoreIMU_LSM6DSOX::getDataY_g() -> float_t{
    return getDataY_mg()/1000;
}            

auto CoreIMU_LSM6DSOX::getDataZ_g() -> float_t {
...
auto CoreIMU_LSM6DSOX::getDataRateAcc() -> int32_t
{
...
void CoreIMU_LSM6DSOX::SetFullScale(fs_xl_t fs_xl)
{
	lsm6dsox_xl_full_scale_set(&getRegisterIOFunction(), static_cast<lsm6dsox_fs_xl_t>(fs_xl));
}

void CoreIMU_LSM6DSOX::TurnOffAcc()
{
	lsm6dsox_xl_data_rate_set(&getRegisterIOFunction(), LSM6DSOX_XL_ODR_OFF);

}

	/********** Gyroscope ********/

auto CoreIMU_LSM6DSOX::getDataX_mdps() -> float_t {
    lsm6dsox_data_t data;
    lsm6dsox_data_get(&getRegisterIOFunction(), nullptr, &getConfig(), &data);
	return data.ui.gy.mdps[0];
}

auto CoreIMU_LSM6DSOX::getDataY_mdps() -> float_t{
    lsm6dsox_data_t data;
    lsm6dsox_data_get(&getRegisterIOFunction(), nullptr, &getConfig(), &data);
	return data.ui.gy.mdps[1];
}            

auto CoreIMU_LSM6DSOX::getDataZ_mdps() -> float_t {
    lsm6dsox_data_t data;
    lsm6dsox_data_get(&getRegisterIOFunction(), nullptr, &getConfig(), &data);
	return data.ui.gy.mdps[2];
}


auto CoreIMU_LSM6DSOX::getDataX_dps() -> float_t {
    return getDataX_mdps()/1000;
}

auto CoreIMU_LSM6DSOX::getDataY_dps() -> float_t{
    return getDataY_mdps()/1000;
}            

auto CoreIMU_LSM6DSOX::getDataZ_dps() -> float_t {
    return getDataZ_mdps()/1000;
}
...
void CoreIMU_LSM6DSOX::SetFullScale(fs_g_t fs_gy)
{
...
{
	lsm6dsox_gy_data_rate_set(&getRegisterIOFunction(), LSM6DSOX_GY_ODR_OFF);
