...
CoreIMULSM6DSOX::CoreIMULSM6DSOX(mbed::I2C &i2c, PinName pin_interrupt)
...
auto CoreIMULSM6DSOX::getAccelAndAngularSpeed() -> std::tuple<interface::mg_t, interface::mg_t, interface::mg_t, interface::dps_t, interface::dps_t, interface::dps_t>
{
	updateData();
