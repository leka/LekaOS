...
#define MCU_ID_FRONT  uint32_t PTR_32BITS_REG(U_ID_REG + 0x0)
#define MCU_ID_MIDDLE uint32_t PTR_32BITS_REG(U_ID_REG + 0x4)
#define MCU_ID_BACK	  uint32_t PTR_32BITS_REG(U_ID_REG + 0x8)
