...
struct CRGB {
	...
	inline CRGB(const CHSV &rhs) __attribute__((always_inline)) { hsv2rgb_rainbow(rhs, *this); }
	...
	inline operator bool() const __attribute__((always_inline)) { return r || g || b; }
...
{
	return CRGB(qmul8(p1.r, d), qmul8(p1.g, d), qmul8(p1.b, d));
}
...
__attribute__((always_inline)) inline CRGB operator&(const CRGB &p1, const CRGB &p2)
{
	return CRGB(p1.r < p2.r ? p1.r : p2.r, p1.g < p2.g ? p1.g : p2.g, p1.b < p2.b ? p1.b : p2.b);
}
