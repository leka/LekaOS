...
class CHSVPalette16
{
  public:
	...
	CHSVPalette16(const CHSVPalette16 &rhs) { memmove8((void *)&(entries[0]), &(rhs.entries[0]), sizeof(entries)); }
	...
	inline CHSV &operator[](uint8_t x) __attribute__((always_inline)) { return entries[x]; }
	inline const CHSV &operator[](uint8_t x) const __attribute__((always_inline)) { return entries[x]; }

	inline CHSV &operator[](int x) __attribute__((always_inline)) { return entries[(uint8_t)x]; }
	inline const CHSV &operator[](int x) const __attribute__((always_inline)) { return entries[(uint8_t)x]; }
	...
	bool operator!=(const CHSVPalette16 rhs) { return !(*this == rhs); }
...
class CHSVPalette256
{
  public:
	...
	CHSVPalette256(const CHSVPalette256 &rhs) { memmove8((void *)&(entries[0]), &(rhs.entries[0]), sizeof(entries)); }
	...
	bool operator!=(const CHSVPalette256 rhs) { return !(*this == rhs); }
...
class CRGBPalette16
{
  public:
	...
	CRGBPalette16(const CRGBPalette16 &rhs) { memmove8((void *)&(entries[0]), &(rhs.entries[0]), sizeof(entries)); }
	CRGBPalette16(const CRGB rhs[16]) { memmove8((void *)&(entries[0]), &(rhs[0]), sizeof(entries)); }
	...
	bool operator!=(const CRGBPalette16 rhs) { return !(*this == rhs); }

	inline CRGB &operator[](uint8_t x) __attribute__((always_inline)) { return entries[x]; }
	inline const CRGB &operator[](uint8_t x) const __attribute__((always_inline)) { return entries[x]; }

	inline CRGB &operator[](int x) __attribute__((always_inline)) { return entries[(uint8_t)x]; }
	inline const CRGB &operator[](int x) const __attribute__((always_inline)) { return entries[(uint8_t)x]; }
...
class CHSVPalette32
{
  public:
	...
	CHSVPalette32(const CHSVPalette32 &rhs) { memmove8((void *)&(entries[0]), &(rhs.entries[0]), sizeof(entries)); }
	...
	bool operator!=(const CHSVPalette32 rhs) { return !(*this == rhs); }
...
class CRGBPalette32
{
  public:
	...
	CRGBPalette32(const CRGBPalette32 &rhs) { memmove8((void *)&(entries[0]), &(rhs.entries[0]), sizeof(entries)); }
	CRGBPalette32(const CRGB rhs[32]) { memmove8((void *)&(entries[0]), &(rhs[0]), sizeof(entries)); }
	...
	bool operator!=(const CRGBPalette32 rhs) { return !(*this == rhs); }
...
class CRGBPalette256
{
  public:
	...
	CRGBPalette256(const CRGBPalette256 &rhs) { memmove8((void *)&(entries[0]), &(rhs.entries[0]), sizeof(entries)); }
	CRGBPalette256(const CRGB rhs[256]) { memmove8((void *)&(entries[0]), &(rhs[0]), sizeof(entries)); }
	...
	bool operator!=(const CRGBPalette256 rhs) { return !(*this == rhs); }
