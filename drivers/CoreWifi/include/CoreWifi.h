...
class CoreWifi : public WiFiInterface
{
  public:
	...
	auto set_credentials(const char *ssid, const char *password, nsapi_security_t security = NSAPI_SECURITY_NONE) -> int final;
	...
	auto connect(const char *ssid, const char *password, nsapi_security_t security = NSAPI_SECURITY_NONE, uint8_t channel = 0)
		-> nsapi_error_t final;
