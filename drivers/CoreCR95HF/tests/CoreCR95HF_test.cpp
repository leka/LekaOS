...
TEST_F(CoreCR95HFSensorTest, sendCommandSuccess)
{
	const auto expected_values =
		ElementsAre(0x04, 0x0e, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff);

	std::array<uint8_t, 14> command = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
