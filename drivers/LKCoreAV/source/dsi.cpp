...
void LKDSI::initialize()
{
	...
	hdsivideo.PacketSize = screen_property.HACT; /* Value depending on display orientation choice portrait/landscape */
	...
	hdsivideo.HorizontalLine =
		((screen_property.HACT + screen_property.HSA + screen_property.HBP + screen_property.HFP) * laneByteClk_kHz) /
