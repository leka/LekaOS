...
#define MBED_CONF_APP_TARGET_NAME								   "LEKA_V1_0_DEV"	 // set by application[LEKA_V1_0_DEV]
...
#define MBED_CONF_BLUENRG_MS_SPI_IRQ							 BLE_IRQ		// set by application[LEKA_V1_0_DEV]
#define MBED_CONF_BLUENRG_MS_SPI_MISO							 BLE_SPI_MISO	// set by application[LEKA_V1_0_DEV]
#define MBED_CONF_BLUENRG_MS_SPI_MOSI							 BLE_SPI_MOSI	// set by application[LEKA_V1_0_DEV]
#define MBED_CONF_BLUENRG_MS_SPI_NCS							 BLE_SPI_NSS	// set by application[LEKA_V1_0_DEV]
#define MBED_CONF_BLUENRG_MS_SPI_RESET							 BLE_RESET		// set by application[LEKA_V1_0_DEV]
#define MBED_CONF_BLUENRG_MS_SPI_SCK							 BLE_SPI_SCK	// set by application[LEKA_V1_0_DEV]
...
#define MBED_CONF_SD_SPI_CLK											  SD_SPI_SCK   // set by application[LEKA_V1_0_DEV]
#define MBED_CONF_SD_SPI_CS												  SD_SPI_CS	  // set by application[LEKA_V1_0_DEV]
#define MBED_CONF_SD_SPI_MISO											  SD_SPI_MISO	// set by application[LEKA_V1_0_DEV]
#define MBED_CONF_SD_SPI_MOSI											  SD_SPI_MOSI	// set by application[LEKA_V1_0_DEV]
...
#define MBED_CONF_TARGET_FLASH_DUAL_BANK								  0				// set by target:LEKA_V1_0_DEV
...
#define MBED_CONF_TARGET_LSE_AVAILABLE									  0			   // set by target:LEKA_V1_0_DEV
#define MBED_CONF_TARGET_MPU_ROM_END									  0x0fffffff   // set by target:Target
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE					  WIFI		   // set by target:LEKA_V1_0_DEV
