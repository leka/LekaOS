...
class LKCoreSTM32HalMock : public LKCoreSTM32HalBase
{
  public:
	...
	MOCK_METHOD(void, HAL_LINKDMA_SDRAM,
				(SDRAM_HandleTypeDef * hsdram, DMA_HandleTypeDef *hdma, DMA_HandleTypeDef dma_handle), (override));

	MOCK_METHOD(void, HAL_LINKDMA_DAC,
				(DAC_HandleTypeDef * hdac, DMA_HandleTypeDef *DMA_Handle1, DMA_HandleTypeDef dma_handle), (override));
