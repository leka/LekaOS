/**
******************************************************************************
* @file    LSM6DSOX_ComponentAccelerometer.h
* @author  Yann Locatelli
* @brief   Implementation of Component::AccelerometerBase for LSM6DSOX Accelerometer
******************************************************************************
*/

/* Prevent recursive inclusion -----------------------------------------------*/
#ifndef __LSM6DSOX_COMPONENTACCELEROMETER_H__
#define __LSM6DSOX_COMPONENTACCELEROMETER_H__

/* Includes ------------------------------------------------------------------*/
#include "CommunicationI2CBase.h"
#include "ComponentAccelerometerBase.h"
...
namespace Component {
	 ...
	 */
	class LSM6DSOX_Accelerometer : AccelerometerBase {
	  public:
		LSM6DSOX_Accelerometer(Communication::I2CBase &component_i2c, PinName pin_interrupt);
		virtual Status init();
		...
		virtual Status setRange(AccelerometerRange range);
		virtual Status getRange(AccelerometerRange &range);
...
#endif	 // __LSM6DSOX_COMPONENTACCELEROMETER_H__