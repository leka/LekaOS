...
*/
/*
const std::uint8_t DiagDownLeft = 11;
const std::uint8_t DiagDownRight = 7;
const std::uint8_t DiagUpLeft = 10;
const std::uint8_t DiagUpRight = 4;
const std::uint8_t ArcDownRight = 2;
const std::uint8_t ArcUpRight = 5;
const std::uint8_t ArcDownLeft = 6;
const std::uint8_t ArcUpLeft = 8;
const std::uint8_t Down = 13;
const std::uint8_t Idle = 3;
const std::uint8_t Left = 9;
const std::uint8_t Right = 0;
const std::uint8_t Up = 12;
*/
std::uint16_t id_square_clockwise = 0x0015;//carré
std::uint16_t id_square_counter_clockwise = 0x0002; //dé

std::uint16_t id_rhombus_clockwise = 0x0005; //bleu
...
std::uint16_t id_star_clockwise = 0x0018;//etoile
std::uint16_t id_star_counter_clockwise = 0x0007; //jaune
std::uint16_t id_triangle_rect_up_left_clockwise = 0x000A; //zéro
...
std::uint16_t id_Circle_C = 0x0016;//cercle
std::uint16_t id_Circle_CC = 0x0009;//rouge
...
/*
std::array<leka::AbstractField*, 24> shapes = {&squareC, &squareCC,
										&rhombusC, &rhombusCC,
										&circleC, &circleCC,
										&TriangleRectUpLeftC, &TriangleRectUpLeftCC, &TriangleRectUpRightC, &TriangleRectUpRightCC,
										&TriangleRectDownLeftC, &TriangleRectDownLeftCC, &TriangleRectDownRightC, &TriangleRectDownRightCC,
...
//Interrupts
Interrupt inter_DiagDownLeft("Diagonal Down Left", DiagDownLeft, "Down_Left");
Interrupt inter_DiagDownRight("Diagonal Down Right", DiagDownRight, "Down_Right");
Interrupt inter_DiagUpLeft("Diagonal Up Left", DiagUpLeft, "Up_Left");
Interrupt inter_DiagUpRight("Diagonal Up Right", DiagUpRight, "Up_Right");
...
Interrupt inter_Idle("Idle", Idle, "Idle");
Interrupt inter_Left("Left", Left, "Left");
Interrupt inter_Right("Right", Right, "Right");
Interrupt inter_Down("Down", Down, "Down");
Interrupt inter_Up("Up", Up, "Up");


std::array<Interrupt, 9> interrupts_array = {inter_DiagDownLeft, inter_DiagDownRight, inter_DiagUpLeft, inter_DiagUpRight,
												inter_Idle,
...
/*
std::array<Interrupt, 13> interrupts_array = {inter_DiagDownLeft, inter_DiagDownRight, inter_DiagUpLeft, inter_DiagUpRight,
												inter_ArcDownRight, inter_ArcUpRight, inter_ArcDownLeft, inter_ArcUpLeft,
												inter_Idle,
												inter_Left, inter_Right,inter_Down, inter_Up
											};*/
