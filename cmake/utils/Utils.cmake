...
function (target_link_target_board_libraries TARGET)
	if (${TARGET_BOARD} MATCHES "\-x")
		string(REPLACE "\-x " "" CUSTOM_BOARD ${TARGET_BOARD})
		foreach(board IN ITEMS ${ARGN})
			if (${CUSTOM_BOARD} MATCHES ${board})
				message(STATUS ">> Linking ${TARGET} with custom target library ${board}")
